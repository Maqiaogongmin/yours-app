          ...
          await db
              ...
              .insert(
                LocalWorkoutSessionsCompanion.insert(
                  ...
                  routineId: routineId,
                  dayId: Value(dayId),
                  routineNameSnapshot: Value(_asString(snapshot['routineNameSnapshot'])),
                  routineSyncIdSnapshot: Value(_asString(snapshot['routineSyncIdSnapshot'])),
                  dayNameSnapshot: Value(_asString(snapshot['dayNameSnapshot'])),
                  dayWeekSnapshot: Value(_asInt(snapshot['dayWeekSnapshot'])),
                  dayIndexSnapshot: Value(_asInt(snapshot['dayIndexSnapshot'])),
                  daySyncIdSnapshot: Value(_asString(snapshot['daySyncIdSnapshot'])),
                  startedAt: startedAt,
